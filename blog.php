    ...
    <body>
        ...
        <header id="blog">
            <div class="container position-relative">
                <img src="assets/img/img-blog.png" class="img" alt="">
                <div class="row vh-80 d-flex justify-content-between">
                    <div class="col-md-2">
                        <a href="index.php"><img src="assets/img/logo-cinergia-home.svg" width="220px" alt=""></a>
                    </div>
                    <div class="col-md-12 d-flex flex-column align-self-end text-center text-md-start">
                        <h3 class="Valky fc-naranja">Blog</h3>
        ...
        <section class="bg-negro p-150">
            <div class="container">
                <div class="row blog-content wow bounceInLeft">
                ...
                <div class="row mt-0 mt-lg-5 pb-150 d-none d-lg-block wow bounceInLeft">
                    <div class="col-lg-4 offset-lg-8">
                        <h5 class="fc-pastel">by Gabriel Luna | 26, Oct, 2021 | Destacadas, Publicidad</h5>
                    </div>
                </div>

                <div class="row blog-content wow bounceInRight">
                ...
                <div class="row mt-0 mt-lg-5 pb-150 d-none d-lg-block wow bounceInRight">
                    <div class="col-lg-4">
                ...
                <div class="col-12 d-flex justify-content-center justify-content-lg-end wow bounceInLeft">
