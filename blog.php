        ...
        <header id="blog">
            <div class="container position-relative">
                ...
                <div class="row vh-80 d-flex justify-content-between">
                    ...
                    <div class="col-md-12 d-flex flex-column align-self-end">
            ...
            <div class="container">
                <div class="row blog-content">
                    <div class="col-md-6 ps-md-0 d-flex align-self-center">
                        ...
                        <img src="assets/img/arrow-pastel-right.svg" class="arrow" alt="">
                    </div>
                ...
                <div class="row blog-content">
                    ...
                    <div class="col-md-6 pe-md-0 d-flex align-self-center text-end">
                        ...
                        <img src="assets/img/arrow-pastel-left.svg" class="arrow" alt="">
                    </div>
                </div>
                <div class="row mt-50 pb-150">
                    <div class="col-md-4">
