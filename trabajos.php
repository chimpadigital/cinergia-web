...
<html lang="en">
    <head>
        ...
        <title>Cinergia | Del Gredal</title>
    ...
    <body>
        ...
        <div class="container-fluid bg-negro position-relative">
            <div class="row">
                <div class="col p-0 wow bounceInUp">
                    <img src="assets/img/bg-header-gredal.png" width="100%" alt="">
                </div>
            </div>
            <div class="row">
                <div class="col-8 offset-2 col-md-4 offset-md-4 mt--80 d-flex align-items-center justify-content-center position-relative wow bounceInUp">
            ...
            <div class="col-md-3 d-flex justify-content-end align-items-center mt--200 d-none d-md-block wow bounceInLeft">
        ...
        <section class="bg-negro p-100">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-5 offset-md-6 d-none d-md-block wow bounceInRight">
        ...
        <section class="bg-negro">
                ...
                <div class="row">
                    <div class="col wow bounceInUp">
                        <div class="owl-carousel owl-theme">
                            <div class="item">
                                <img src="assets/img/img-carousel-gredal-01.png">
                            </div>
                            <div class="item">
                                <img src="assets/img/img-carousel-gredal-02.png">
                            </div>
                            <div class="item">
                                <img src="assets/img/img-carousel-gredal-03.png">
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col d-block d-md-none wow bounceInUp">
            ...
            <div class="container">
                <div class="row pb-150">
                    <div class="col-md-7 wow bounceInLeft">
                        <h4 class="PoppinsRegular fc-pastel fs-sm-18">Bodega <span class="Valky fc-naranja fs-60 d-none d-md-flex">Del Gredal</span><span class="Valky fc-naranja fs-24 d-flex d-md-none">Del Gredal</span>
                            ...
                            perfecta del lugar. Con un producto que superó expectativas, su desafío, que pasó a ser el nuestro, 
                            era poder mostrar ese valor a quienes no lo conocían.</h4>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6 d-flex justify-content-end align-items-center d-none d-md-flex wow bounceInRight">
                        <img src="assets/img/animation-02.gif" width="200px" alt="">
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid bg-negro p-150">
            <div class="row">
                <div class="col p-0 wow bounceInUp">
                    <img src="assets/img/bg-divider-gredal.png" width="100%" alt="">
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row mb-100 mb-sm-0">
                    ...
                    <div class="col-md-4 mb-4 mb-0 wow bounceInUp">
                        ...
                        <p class="fc-pastel text-center">Por la gente, por el lugar <br> De origen, por nuestros clientes.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 offset-md-2 mb-4 mb-0 wow bounceInUp">
                        <div class="circulo-trabajo d-flex justify-content-center align-items-center mb-4">
                    ...
                    <div class="col-md-4 mb-4 mb-0 wow bounceInUp">
                        ...
                        <p class="fc-pastel text-center">El nuestro es un producto propio <br>
                            Del lugar que elegimos, hecho por gente <br>
                            Local y con la intención de ser una <br>
                            expresión fiel de todo eso.</p>
                    </div>
                </div>
        ...
        <section class="bg-negro p-150 position-relative">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col p-0 wow bounceInUp">
                        <img src="assets/img/bg-gredal-01.png" width="100%" alt="">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 offset-md-2 mt--380 mt-xs-0 wow bounceInUp">
                    ...
                    <div class="col-md-4 mt-md--60 wow bounceInUp">
                ...
                <div class="row mt-300 mt-xs-0">
                    ...
                    <div class="col-md-4 mt-md--60 mt-xs-0 wow bounceInUp">
        ...
        <section class="bg-negro">
            <div class="container-fluid">
                <div class="row d-flex wow bounceInUp">
                    ...
                    <div class="col-md-6 d-flex align-items-center order-1 order-md-2 mb-4 ps-md-4 pe-md-x0 p-0 mb-md-0 wow bounceInUp">
        ...
        <section class="bg-negro pb-150">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 d-flex flex-column justify-content-md-end align-items-md-end mt-sm-100 wow bounceInUp">
                    ...
                    <div class="col-md-6 wow bounceInUp">
                        <img src="assets/img/img-gredal-01.png" width="100%" alt="">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-5 offset-md-2 d-flex flex-column justify-content-md-end align-items-md-end mt-sm-100 wow bounceInUp">
                    ...
                    <div class="col-md-8 pt-150 wow bounceInLeft">
        ...
        <section class="bg-negro">
            <div class="container-fluid d-flex flex-column">
                <div class="row order-2 order-md-1 wow bounceInLeft">
                    <div class="col-md-6 offset-md-6 z-1 pe-md-0 p-0">
                        <img src="assets/img/bg-gredal-04.png" width="100%" alt="">
                    </div>
                </div>
                <div class="row mt--200 mt-sm-0 order-1 order-md-2 mb-4 mb-md-0 wow bounceInRight">
        ...
        <section class="bg-negro pb-150">
            <div class="container-fluid">
                <div class="row">
                    <div class="col p-0 wow bounceInUp">
                        <iframe width="100%" height="800px" src="https://www.youtube.com/embed/lbisciMm7VQ?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>                
            </div>
            <div class="container pt-150">
                <div class="row">
                    <div class="col-md-3 d-flex justify-content-end position-relative wow bounceInLeft">
                        <img src="assets/img/img-pepi-gredal.png" class="img-pepi-gredal" alt="">
                    </div>
        ...
        <section class="bg-negro pb-150">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 d-md-flex justify-content-md-between ficha-box wow bounceInUp">
